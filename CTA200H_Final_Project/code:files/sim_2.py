...
BSEDict = {'xi': 0.5, 'bhflag': 1, 'neta': 0.5, 'windflag': 3, 'wdflag': 1, 'alpha1': 0.25,
...
bpp.to_hdf('datafile2.hdf', key='bpp')
bcm.to_hdf('datafile2.hdf', key='bcm')
initC.to_hdf('datafile2.hdf', key='bcm')
